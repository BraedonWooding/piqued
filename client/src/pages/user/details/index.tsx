    ...
    <HorizontallyCenteredLayout>
      <Formik
        ...
        onSubmit={async ({ ...other }) => {
          ...
          let blob: File | null;
          if (user.profile_picture && user.profile_picture != img) {
          ...
          axios.patch(process.env.NEXT_PUBLIC_API_URL + "/users/" + user.id + "/", formData).then((resp) => {
          ...
          <Form>
            <Container component="main" maxWidth="sm">
              <Box className={classes.card}>
                ...
                <AvatarPicker disabled={false} initialUrl={img} onSaveAvatar={handleSave} />
